		...
		return elm$json$Json$Encode$object(
			_List_fromArray(
				[
					...
					_Utils_Tuple2(
					'octave',
					elm$json$Json$Encode$int($.octave))
				]));
	});
	...
	function (msg, model) {
		switch (msg.$) {
			...
			default:
				...
				return _Utils_Tuple2(
					model,
					author$project$Main$playSound(sound));
		}
	});
	...
	return {
		body: _List_fromArray(
			[
				...
				_List_fromArray(
					[
						elm$html$Html$Attributes$src('treble_clef.svg'),
				...
				_List_fromArray(
					[
						...
						author$project$Main$PlaySound(
							{duration: 1, instrument: 'piano', note: 'C', octave: 4}))
					]),
				_List_fromArray(
					[
